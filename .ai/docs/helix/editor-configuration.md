...
editor-config	Whether to read settings from EditorConfig files	true
[editor.clipboard-provider] Section

Helix can be configured either to use a builtin clipboard configuration or to use a provided command.
