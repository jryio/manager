...
----
refer to https://github.com/helix-editor/helix/wiki/Themes[Theme docs]
...
See also: https://github.com/helix-editor/helix/discussions/10281["Ability to define second theme to sync with OS"]
...
We are not interested in supporting alternative paradigms. The core of Helix's editing is based on `Selection -> Action`, and it would require extensive changes to create a true Vi/Vim keymap. However, there is a:

* third-party keymap: https://github.com/LGUG2Z/helix-vim
* soft fork: https://github.com/usagi-flow/evil-helix
