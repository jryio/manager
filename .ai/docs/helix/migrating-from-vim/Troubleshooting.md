...
There is an issue with tmux where the italic modifier is not shown italic and has a background color instead. Add [this](https://github.com/helix-editor/helix/issues/3099#issuecomment-1552264091) to your tmux conf and restart tmux:
```
...
image: [!Image of iTerm2 Key Mapping preferences showing 'ESC+' selected for Left Option Key](https://user-images.githubusercontent.com/863286/171976942-f14bf078-e830-47b4-a38e-caa20201c139.png)
