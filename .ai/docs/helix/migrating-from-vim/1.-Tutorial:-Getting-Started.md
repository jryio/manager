...
To get started check out the [installation instructions](https://docs.helix-editor.com/install.html) in order to follow along with the tutorial.
...
- <kbd>j</kbd>: moves cursor 1 line below.
- <kbd>k</kbd>: moves cursor 1 line above.
...
The <kbd>Esc</kbd> key is quite far away from the home row on most keyboards; many people remap <kbd>Caps Lock</kbd> to <kbd>Esc</kbd>.

You can find out how to do this in [Remap Caps Lock to Escape](https://github.com/helix-editor/helix/wiki/Recipes#remap-caps-lock-to-escape).
...
Note that pressing <kbd>p</kbd> pastes the contents of the register _after_ the line. To paste _before_, we undo with <kbd>u</kbd> and use <kbd>P</kbd> to paste before.
