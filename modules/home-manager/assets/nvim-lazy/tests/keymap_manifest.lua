...
return {
  ...
  { mode = "n", lhs = "<M-s>", rhs = "<cmd>w<cr><esc>", phase = 2 },
  { mode = "i", lhs = "<M-s>", rhs = "<cmd>w<cr><esc>", phase = 2 },
  { mode = "x", lhs = "<M-s>", rhs = "<cmd>w<cr><esc>", phase = 2 },
  { mode = "s", lhs = "<M-s>", rhs = "<cmd>w<cr><esc>", phase = 2 },
